...
#!
#! Revision:
#!	$Id: e_api_sample_v4r9.py 4046 2026-05-12 03:02:59Z yoshi $
#! 
#! Function:
#!	MFDS, json-api (for v4r9) python sample module (v3.0-000).
#!
#! Create:
#!	2025.07.16
#!	Y.Yoshizawa
...
#!
gp_url_auth		= "https://demo-kabuka.e-shiten.jp/e_api_v4r9/auth/"
gp_authid		= "TXpZeU5ERTFOekV6TVRNd01pMDVNUzAwT1RFMk55MHdPRFE9"
gp_private_key		= b"""
-----BEGIN PRIVATE KEY-----

-----END PRIVATE KEY-----
"""
...
class	e_api_req_if:
	...
	#!
	def	req_login (self, pi_url, pi_authid):
		p_ary	= self._gen_header ()
		p_ary	= self._gen_col_val (p_ary,	"sCLMID",	"CLMAuthLoginRequest")
		p_ary	= self._gen_col_val (p_ary,	"sAuthId",	pi_authid)
	...
	#!
	#!	base64 decode and decrypt by private-key.
	#!
	def	decrypt_url (self, pi_private_key, pi_val):
		import	base64
		from	cryptography.hazmat.primitives.asymmetric import rsa, padding
		from	cryptography.hazmat.primitives import serialization, hashes

		pi_val		= base64.b64decode (pi_val)
		pi_private_key	= serialization.load_pem_private_key (pi_private_key, password=None)

		po_val		= pi_private_key.decrypt (
			pi_val,
			padding.OAEP (
		...
		return (po_val.decode ('ascii').rstrip ('\r\n').rstrip ('\r\n'))


	#!
	#!	some value get from file or login server answer.
	#!
	def	req_or_file_login (self, pi_url, pi_authid, pi_private_key):
		#!
		#!	exit today url file?
		#!
		if self._file_load () != 0:
			...
			#!
			p_ans	= self.req_login (pi_url, pi_authid)
			...
			#!
			self._p_sUrlRequest		= self.decrypt_url (pi_private_key, self._p_sUrlRequest)
			self._p_sUrlMaster		= self.decrypt_url (pi_private_key, self._p_sUrlMaster)
			self._p_sUrlPrice		= self.decrypt_url (pi_private_key, self._p_sUrlPrice)
			self._p_sUrlEvent		= self.decrypt_url (pi_private_key, self._p_sUrlEvent)
			self._p_sUrlEventWebSocket	= self.decrypt_url (pi_private_key, self._p_sUrlEventWebSocket)
...
if __name__ == "__main__":
	...
	#!	auth i/f.
	#!
	p_sts	= p_api.req_or_file_login (gp_url_auth, gp_authid, gp_private_key)
	if p_sts != 0:
		exit (p_sts)
