...
public sealed class BackcastWorkspaceRoot : MonoBehaviour
{
    ...
    void BuildWorkspace()
    {
        ...
        // Merge of #60 (dynamic chart tile family) + #23 (re-homed live tiles): the STATIC Hakoniwa base
        // is [startup, orders, positions, run_result] — the single "chart" tile is retired (deactivated
        // above) and replaced by the dynamic chart:<id> family driven from the universe (#60). The live
        // data tiles are static members fed by _host.Panel (#23 RH2).
