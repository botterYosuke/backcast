...
public static class FloatingWindowResizeE2ERunner
{
    ...
    static string Section5_ControllerFlushFollowAndNegControl(List<GameObject> spawned)
    {
        ...
        c.Spawn(FloatingWindowCatalog.KIND_ORDER,    "B", 280f,  0f, 280f, 180f, true);
        c.Spawn(FloatingWindowCatalog.KIND_ORDER, "C", 560f,  0f, 280f, 180f, true);
        c.Spawn(FloatingWindowCatalog.KIND_ORDER, "Z", 840f, 0f, 280f, 180f, true);   // external (no group)
    ...
    static string Section6_ControllerMinClamp(List<GameObject> spawned)
    {
        ...
        c.Spawn(FloatingWindowCatalog.KIND_ORDER, "Bf", 400f, -400f, 280f, 180f, true);
    ...
    static string Section9_DiskRoundTripNonVacuous(List<GameObject> spawned)
    {
        ...
        c.Spawn(FloatingWindowCatalog.KIND_ORDER, "B", 401.0f, -50.5f, 280.5f, 200.5f, true);
    ...
    static string Section12_RaiseAndFocusOnGrab(List<GameObject> spawned)
    {
        ...
        c.Spawn(FloatingWindowCatalog.KIND_ORDER, "front", 0f, 0f, 300f, 200f, true);   // spawned later ⇒ in front
