...
def build_instruments_from_master_records(
    records: Iterable[dict[str, Any]],
) -> list["InstrumentRaw"]:
    """Build Phase-8 ``InstrumentRaw`` rows from a CLMEventDownload record stream.
    ...
    for rec in records:
        ...
        if clmid == "CLMYobine":
            ...
            yobine_table[decoded.sYobineTaniNumber] = decoded.bands
        elif clmid == "CLMIssueMstKabu":
            code = rec.get("sIssueCode")
